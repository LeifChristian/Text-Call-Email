...
router.post("/sendVoice", async (req, res) => {
  ...
  // below is if you want twilio to read from an xml file
  ...
  //    from: "+10462154416"
  //  })
  // .then(call => console.log(call.sid), console.log('yesaye'));
  ...
  client.calls
      .create({
         twiml: `<Response><Pause length="1"/><Say voice="woman"> ${today.toDateString().slice(4)}!! ${req.body.Data}</Say></Response>`,
         to: req.body.Number,
         from: '+14062154416'
       })
...
router.post("/sendEmail", async (req, res) => {
  ...
  if (req.body.Data) {
    ...
    function sendMessage(auth) {
      var raw = makeBody(
        req.body.Email ? req.body.Email : "mtmusicandart@gmail.com",
        "",
        "Email from Leify",
        req.body.Data
      );
